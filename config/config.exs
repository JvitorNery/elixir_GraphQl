...
config :graphical, GraphicalWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "HHx6HcJmsR2dxu639nyPLJYPGvaaqBTSOWzy6fa/yAQQK60AdYW8+y+3haIIQI/V",
...
config :graphical, Graphical.Guardian,
  issuer: "graphical",
  secrete_key: "rV6FxzHsBUAeiFGRJBbGv4mmSibc4TWNHRg2PQItGZnIs/B/0nckagMIrks+XewR"
